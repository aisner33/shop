<?php
App::uses('ChildsectionsProductsController', 'Controller');

/**
 * ChildsectionsProductsController Test Case
 *
 */
class ChildsectionsProductsControllerTest extends ControllerTestCase {
