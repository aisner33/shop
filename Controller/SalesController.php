 ...
 */
	public function add() {
		...
		$colors = $this->Sale->Color->find('list');
		$sizes = $this->Sale->Size->find('list');
		$products = $this->Sale->Product->find('list');
		$users = $this->Sale->User->find('list');
		$promotioncodes = $this->Sale->Promotioncode->find('list');
		$offers = $this->Sale->Offer->find('list');
		$deliveries = $this->Sale->Delivery->find('list');
		$this->set(compact('colors', 'sizes', 'products', 'users', 'promotioncodes', 'offers', 'deliveries'));
	}
