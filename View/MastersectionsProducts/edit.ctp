...
<?php echo $this->Form->create('MastersectionsProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mastersections Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MastersectionsProduct.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MastersectionsProduct.id'))); ?></li>
