...
<?php echo $this->Form->create('Fathersection'); ?>
	<fieldset>
		<legend><?php echo __('Edit Fathersection'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Fathersection.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Fathersection.id'))); ?></li>
