<div class="wishlists index">
	...
	<tr>
		...
		<td><?php echo h($wishlist['Wishlist']['created']); ?>&nbsp;</td>
		<td><?php echo h($wishlist['Wishlist']['description']); ?>&nbsp;</td>
		<td><?php echo h($wishlist['Wishlist']['visible']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $wishlist['Wishlist']['id']), null, __('Are you sure you want to delete # %s?', $wishlist['Wishlist']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
