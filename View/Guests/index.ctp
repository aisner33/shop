<div class="guests index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('invitedDate'); ?></th>
			<th><?php echo $this->Paginator->sort('aceptedInviatation'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($guest['Guest']['genre']); ?>&nbsp;</td>
		<td><?php echo h($guest['Guest']['invitedDate']); ?>&nbsp;</td>
		<td><?php echo h($guest['Guest']['aceptedInviatation']); ?>&nbsp;</td>
		<td class="actions">
