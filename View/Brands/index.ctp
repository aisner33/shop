<div class="brands index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('smallImage'); ?></th>
			<th><?php echo $this->Paginator->sort('mediumImage'); ?></th>
			<th><?php echo $this->Paginator->sort('largeImage'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($brand['Brand']['smallImage']); ?>&nbsp;</td>
		<td><?php echo h($brand['Brand']['mediumImage']); ?>&nbsp;</td>
		<td><?php echo h($brand['Brand']['largeImage']); ?>&nbsp;</td>
		<td><?php echo h($brand['Brand']['importance']); ?>&nbsp;</td>
